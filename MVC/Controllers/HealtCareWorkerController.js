...
import otpRouter1 from '../../src/Routes/OtpRouter.js';
...
// healthcareworkerRouter.post('/getAll', async (req, res, next) => {
//     try {
//         const roleId = req.body.roleId;
//         const page = Number(req.body.page) || 1;
//         const limit = Math.min(Number(req.body.limit) || 10, 100);
//         const skip = (page - 1) * limit;
//         const result = await UserModels.find({ "roleId": roleId }).skip(skip).limit(limit).sort({ createdAt: -1 });
//         if (result) {
